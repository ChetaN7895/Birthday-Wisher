...
const Birthday = ({ name, day, month }) => {
  ...
  if (name === undefined || day === undefined || month === undefined) {
    ...
    name = 'Chetan Solanki'; // Name of the Person 'Chetan Solanki'
      ...
      {!isItBday && (
        <>
          ...
          <div className='credits'>
            <a href='https://github.com/ChetaN7895'>
              <img src={githubLogo} alt='Github-Logo' className='github-logo' />
            </a>
          </div>
          <Link to='/generate'>Enter Your Birth-date To Count-Down</Link>

         
        </>
      )}

      <h1>Make By Chetan Solanki</h1>
    </div>
  );
};
